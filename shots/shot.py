...
"""
import json
from dcl_bot.utils import parse_tuple
from bot.commando_query import call_fx_api
from dcl_bot.mysql_base import SQLExecutor
...
# print(old_alarm_query('101，郊区'))
# print(call_fx_api('chengzhikun', '301'))
# print(fuzzy_query('206-袁店'))
sql_executor = SQLExecutor()
result = sql_executor.executor('yw', "1862")[:2000]
result = parse_tuple(result)
print(result)
